...
def test():
    ...
    A = np.array([[0.2, 0.4, 0.1, 0.2, 0.1], \
                  [0.5, 0.1, 0.1, 0.1, 0.2],\
                  [1./5, 1./5, 1./5, 1./5, 1./5],\
                  [0.3, 0.2, 0.1, 0.3, 0.1], \
                  [1./5, 1./5, 1./5, 1./5, 1./5], \
    ...
    emmissionModel = \
        Gaussian(mu = np.array([[588.85 , 417.44, 450.70, 300.08, 157.70]]), \
                            covar = np.array([[[3600.05]], \
                                              [[3200.68]], \
                                              [[2400.58]], \
                                              [[3500.32]], \
                                              [[2912.44]]]))
    ...
    obs[0]= np.loadtxt("dataTypeD.csv",delimiter=",",skiprows=1)[np.newaxis,:]
